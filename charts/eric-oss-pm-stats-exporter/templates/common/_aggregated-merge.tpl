...
*/ -}}
{{- define "eric-oss-pm-stats-exporter.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-pm-stats-exporter.mergeAnnotations" -}}
  {{- include "eric-oss-pm-stats-exporter.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-pm-stats-exporter.mergeLabels" -}}
  {{- include "eric-oss-pm-stats-exporter.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
